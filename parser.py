...
class pProgBuffer(Buffer):
    def __init__(
        ...
        **kwargs
        ...
        super(pProgBuffer, self).__init__(
            text,
...
class pProgParser(Parser):
    def __init__(
        ...
        keywords=None,
        namechars='',
        buffer_class=pProgBuffer,
        **kwargs
    ):
        if keywords is None:
            keywords = KEYWORDS
        super(pProgParser, self).__init__(
            whitespace=whitespace,
            nameguard=nameguard,
            comments_re=comments_re,
            eol_comments_re=eol_comments_re,
...
if __name__ == '__main__':
    ...
    ast = generic_main(main, pProgParser, name='pProg')
    print('AST:')
    print(ast)
    print()
    print('JSON:')
